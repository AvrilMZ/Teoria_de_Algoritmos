...
'''
En este problema nuestro caso optimo seria que el elemento mas grande este en un subconjunto y que todos los demas esten en el otro
peor caso seria que el ultimo elemento que pongamos sea el mayor de todos, desbalanceando la sumatoria de uno de ellos. Suponiendo que, dados los dos conjuntos, se van agregando elementos siempre a aquel conjunto cuya sumatoria sea la menor y el elemento mas grande queda para el final (con tamaño n). El elemento mas grande que se podria poner es n - 1, entonces tenemos las restincciones:
