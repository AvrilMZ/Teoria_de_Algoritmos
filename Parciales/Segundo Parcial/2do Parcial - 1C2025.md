...
c. Dado que disponemos de una grilla $nxn$ donde cada celda tiene como máximo 4 adyacentes y como mínimo 2 (según corresponda), en el peor de los casos tendremos a dos vertices con pesos muy grandes juntos. Podemos considerar que seria peor cuanto mas cantidad de adyacentes haya, ya que afectaria el coeficiente de los otros adyacentes por un vertice que no se puede utilizar (suponiendo que el otro vertice con peso muy grande pertence a la solucion), es asi que podemos aproximar un 3/4-aproximacion, siendo 4 los vecinos y uno de ellos el que genera "perdida".