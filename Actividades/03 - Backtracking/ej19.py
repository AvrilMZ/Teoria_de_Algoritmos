...
def obtener_cambio(
    n, monedas, cantidad_x_monedas, suma_restante, cambio_actual, i_moneda, mejor_sol
):
    ...
    for i in range(
        cantidad_x_monedas[monedas[i_moneda]] + 1
    ):  # + 1 para contar el caso 0 (que no se agrega ninguna moneda) y el ultimo
